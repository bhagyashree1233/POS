...
*/
       ...
       // $cordovaSQLite.execute($rootScope.db, "DROP TABLE BillDetails").then(console.log('TableInfo table droped Successfully')); 
        ...
        $cordovaSQLite.execute($rootScope.db, "CREATE TABLE IF NOT EXISTS BillDetails (BillNo integer, TotalPrice real, DiscountAmount real, TaxAmount real, TotalAmountDiscount real, TotalAmount real, PaymentMethod text, DateTime text, TotalItems integer, BillStatus text)").then(console.log('BillDetails table created Successfully'));
