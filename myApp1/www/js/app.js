...
angular.module('starter', ['ionic', 'starter.controller', 'starter.services', 'ion-digit-keyboard', 'ngCordova', 'ion-floating-menu']).run(function($ionicPlatform, $cordovaSQLite, $rootScope, $q, settingService, salesService, dbService, $ionicLoading) {
    var dfd = $q.defer();
